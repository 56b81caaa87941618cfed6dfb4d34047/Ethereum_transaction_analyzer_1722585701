...
Vue.component("items_table_component_1722586079", {
    template: `
        ...
        <div id="costs-table-container" class="overflow-x-auto">
            <table id="costs-table" class="table-auto w-full text-sm">
                ...
                <tbody id="costs-table-body">
                    <tr class="group bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm hover:bg-opacity-30 transition-all duration-300" id="costs-row-1">
                        ...
                        <td class="relative font-semibold text-right px-4 py-5 first:rounded-l-lg last:rounded-r-lg w-[1%] text-white" id="costs-cell-cost-1">
                            <a class="transition-opacity before:absolute before:inset-0 before:z-20 before:rounded-lg" href="details.html" tabindex="-1">$99/month</a>
                        </td>
                    </tr>
                    <tr class="group bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm hover:bg-opacity-30 transition-all duration-300" id="costs-row-2">
                        ...
                        <td class="relative font-semibold text-right px-4 py-5 first:rounded-l-lg last:rounded-r-lg w-[1%] text-white" id="costs-cell-cost-2">
                            <a class="transition-opacity before:absolute before:inset-0 before:z-20 before:rounded-lg" href="details.html" tabindex="-1">$499/month</a>
                        </td>
                    </tr>
                    <tr class="group bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm hover:bg-opacity-30 transition-all duration-300" id="costs-row-3">
                        ...
                        <td class="relative font-semibold text-right px-4 py-5 first:rounded-l-lg last:rounded-r-lg w-[1%] text-white" id="costs-cell-cost-3">
                            <a class="transition-opacity before:absolute before:inset-0 before:z-20 before:rounded-lg" href="details.html" tabindex="-1">$999/month</a>
                        </td>
                    </tr>
                    <tr class="group bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm hover:bg-opacity-30 transition-all duration-300" id="costs-row-4">
                        ...
                        <td class="relative font-semibold text-right px-4 py-5 first:rounded-l-lg last:rounded-r-lg w-[1%] text-white" id="costs-cell-cost-4">
                            <a class="transition-opacity before:absolute before:inset-0 before:z-20 before:rounded-lg" href="details.html" tabindex="-1">$199/wallet/month</a>
                        </td>
                    </tr>
                    <tr class="group bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm hover:bg-opacity-30 transition-all duration-300" id="costs-row-5">
                        ...
                        <td class="relative font-semibold text-right px-4 py-5 first:rounded-l-lg last:rounded-r-lg w-[1%] text-white" id="costs-cell-cost-5">
                            <a class="transition-opacity before:absolute before:inset-0 before:z-20 before:rounded-lg" href="details.html" tabindex="-1">$5000/investigation</a>
                        </td>
                    </tr>
                    <tr class="group bg-white bg-opacity-20 backdrop-filter backdrop-blur-sm hover:bg-opacity-30 transition-all duration-300" id="costs-row-6">
                        ...
                        <td class="relative font-semibold text-right px-4 py-5 first:rounded-l-lg last:rounded-r-lg w-[1%] text-white" id="costs-cell-cost-6">
                            <a class="transition-opacity before:absolute before:inset-0 before:z-20 before:rounded-lg" href="details.html" tabindex="-1">$250/hour</a>
                        </td>
                    </tr>
                </tbody>
                <tfoot id="costs-table-footer">
                    <tr>
                        ...
                        <td id="total-cost" class="relative font-semibold text-right text-base underline px-4 py-5 w-[1%] text-purple-300">View Pricing</td>
                    </tr>
                </tfoot>
            </table>
        </div>
